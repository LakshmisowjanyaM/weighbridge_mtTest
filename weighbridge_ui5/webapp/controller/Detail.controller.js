sap.ui.define([
    ...
    return BaseController.extend("weighbridgeui5.controller.Detail", {
        ...
        handleSaveWeight: function(oEvent){
            ...
            function fnSuccess() {
                ...
                method: "POST",               
                urlParameters: {              
                "Ebeln" : oView.byId("semPageTitle").getText(),              
                "VehicalNo" : oView.byId("idVehicle").getValue(),
                "GrossWeight":oView.byId("idGW").getText(),
                "TareWeight":oView.byId("idTW").getText(),
        ...
        _updateCloudTable:function(WObj,eFlag){
            var oView=this.getView();
            var oDataModel = this.getOwnerComponent().getModel("ZSB_WEIGHBRIDGEtest");
           var wLObj={
            "docno":WObj.Ebeln,
            "vehicle_num":WObj.VehicalNo,
            "error_status":eFlag===undefined?"":eFlag,
            "grosswt_time":"",
            "tarewt_time":"",
            "gross_wt":WObj.GrossWeight,
            "tare_wt":WObj.TareWeight,
            "net_wt":oView.byId("idNW").getText(),
            "uom":WObj.UnitOfMeasure,
            "local_timezone":""
           };
           oDataModel.create("/ZI_WB_LOG",wLObj,null,function(){
        ...
        calculateNetWeight: function (oEvent) {
            ...
            var local_GWt = parseFloat(this.getView().byId("idGW").getText());
            var local_TWt = parseFloat(this.getView().byId("idTW").getText());
