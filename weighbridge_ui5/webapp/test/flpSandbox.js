		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "WeighBridge",
									"targetURL": "#weighbridgeui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"weighbridgeui5-display": {
								"semanticObject": "weighbridgeui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=weighbridgeui5",
									"url": sap.ui.require.toUrl("weighbridgeui5")
								}
							}
						}
					}
